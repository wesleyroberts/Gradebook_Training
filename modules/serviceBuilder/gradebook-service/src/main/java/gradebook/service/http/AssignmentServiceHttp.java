...
public class AssignmentServiceHttp {
	...
	public static gradebook.model.Assignment addAssignment(
		...
		try {
			...
			return (gradebook.model.Assignment)returnObj;
		}
	...
	public static gradebook.model.Assignment deleteAssignment(
	...
	public static gradebook.model.Assignment getAssignment(
			HttpPrincipal httpPrincipal, long assignmentId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	public static java.util.List<gradebook.model.Assignment>
		...
		try {
			...
			return (java.util.List<gradebook.model.Assignment>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException
					systemException) {
	...
	public static gradebook.model.Assignment updateAssignment(
			HttpPrincipal httpPrincipal, long assignmentId,
			java.util.Map<java.util.Locale, String> titleMap,
			java.util.Map<java.util.Locale, String> descriptionMap,
			java.util.Date dueDate,
