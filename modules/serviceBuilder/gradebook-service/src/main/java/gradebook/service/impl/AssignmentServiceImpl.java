...
import gradebook.service.base.AssignmentServiceBaseImpl;
 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>gradebook.service.AssignmentService</code> interface.
 *
 * <p>
...
public class AssignmentServiceImpl extends AssignmentServiceBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Always use <code>gradebook.service.AssignmentServiceUtil</code> to access the assignment remote service.
	 */
